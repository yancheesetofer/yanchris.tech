...
| Scene | What it looks like | Feels like |
|-------|-------------------|------------|
| **“What-If-Apocalypse” Planning** | Colleague sketches *five* database shards “for when we hit fifty billion users.” | ☠️ *Bruh* we have 5 monthly actives. |
| **Premature Framework Frenzy** | Someone forks six libraries because “We might migrate to GraphQL later.” | 🥴 RIP onboarding docs. |
| **Infinite Abstraction Layer** | A “helperFactoryAdapterManager” shows up in the PR. | 🤡 IntelliSense crying in the club. |
